...
echo "\033[37;1m[] AUTHOR :  RAHMAD FITRA KUN                          []"|lolcat
echo "\033[35;1m[] W A    :  088262147113                              []"|lolcat
echo "\033[36;1m[] F B    :  Korek Api                                 []"|lolcat
...
echo $red"          <©>=========================<®>"
echo $green"          <©>=========================<®>"
echo $red"          ( !! ) [ Tools Ada Yang Vuln Dan Tidak Vuln ]"|lolcat
echo $red"          <©>=========================<®>"
echo "\033[33;1m"
